    ...
    with tf.variable_scope(scope, default_name="bert"):
      ...
      with tf.variable_scope("pooler"):
        ...
        for i in range(heads):
          ...
          self.Mw.add(tf.keras.layers.Dense(middle_dim, 'tanh', kernel_initializer=create_initializer(config.initializer_range)))
          self.Mw.add(tf.keras.layers.Dense(final_dim, 'tanh'))
