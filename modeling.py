    ...
    with tf.variable_scope(scope, default_name="bert"):
      ...
      with tf.variable_scope("pooler"):
        ...
        for i in range(heads):
          ...
          self.Mw.add(tf.keras.layers.Dense(config.hidden_size, middle_dim, 'tanh', kernel_initializer=create_initializer(config.initializer_range)))
          self.Mw.add(tf.keras.layers.Dense(middle_dim, final_dim, 'tanh'))
      ...
      with tf.variable_scope("attention"):
        ...
        with tf.variable_scope("self"):
          attention_head = attention_layer(
              ...
              last_layer=layer_idx == num_hidden_layers-1)
